...
Route::group(['prefix' => 'parent'], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::group(
                ['middleware' => ['auth:sanctum', 'checkChild']],
                function () {
                        ...
                        //behavior
                        Route::get('behavior', [ParentApiController::class, 'getBehavior']);
                    }
            );
        }
    );
...
Route::group(['prefix' => 'teacher'], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::group(
                ['middleware' => ['auth:sanctum', 'checkStudent']],
                function () {
            ...
            //Behavior
            Route::get('get-behavior', [TeacherApiController::class, 'getBehavior']);
            Route::post('create-behavior', [TeacherApiController::class, 'createBehavior']);
            Route::post('update-behavior', [TeacherApiController::class, 'updateBehavior']);
            Route::post('delete-behavior', [TeacherApiController::class, 'deleteBehavior']);
        }
    );
});
